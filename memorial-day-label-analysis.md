...
| Metric | Baseline (May 11–24) | Memorial Day (May 25) | Delta |
|--------|---------------------|-----------------------|-------|
| IAP Rate D1 (overall) | 1.081% | 1.143% | **+5.7%** |
| IAP Rate D3 (overall) | 1.240% | 1.309% | **+5.5%** |
| IAP Rate D1 (attributed) | 0.488% | 0.527% | **+7.8%** |
| IAP Rate D1 (unattributed) | 2.072% | 2.146% | **+3.5%** |
| Avg IAP Amount D1 | $18.59 | $19.32 | +3.9% (normal) |
| AdRev Rate D1 (attributed) | 71.64% | 71.59% | -0.1% (flat) |
| AdRev Rate D1 (unattributed) | 0% | 0% | N/A by design |
| Retention Rate D1 (attributed) | 21.90% | 21.88% | flat |
| Retention Rate D1 (overall) | 13.61% | 13.55% | flat |
| Daily Row Count | 10.72M avg | 10.10M | -5.8% |

**Attributed installs show the stronger relative IAP uplift (+7.8%) vs unattributed (+3.5%)**, though unattributed IAP rate is structurally ~4x higher in absolute terms (organic/re-engaged users).
